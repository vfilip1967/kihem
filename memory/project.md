...
- The service toolbar includes Melodos-style reading scroll: nine one-pixel
  speeds, pause/resume, arrow-key speed changes, Space pause, and persisted
  speed selection; level 0 is manual scrolling.
